...
influx_client.create_continuous_query(company_id, '5s', 'expire_in_24h_rp', '1m')
influx_client.create_retention_policy(company_id, 'expire_in_30d_rp', '30d')
influx_client.create_continuous_query(company_id, '5m', 'expire_in_30d_rp', '10m')
influx_client.create_retention_policy(company_id, 'expire_in_1yr_rp', '365d')
influx_client.create_continuous_query(company_id, '1h', 'expire_in_1yr_rp', '1h')
